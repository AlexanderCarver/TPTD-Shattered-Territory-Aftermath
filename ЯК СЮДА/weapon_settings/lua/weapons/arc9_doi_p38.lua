...
SWEP.Description = [[Standard-issue German 9mm pistol.]]

SWEP.ViewModel = "models/weapons/arc9_doi/c_p38.mdl"
...
SWEP.ShootSound = "weapons/arc9_doi/p38/p38_fp.wav"
SWEP.DistantShootSound = "weapons/arc9_doi/p38/p38_dist.wav"

SWEP.DryFireSound = "weapons/arc9_doi/p38/handling/p38_empty.wav"
...
SWEP.CustomizePos = Vector(16, 32, 0)

SWEP.CustomizeRotateAnchor = Vector(15, -2.48, -3)
...
local path = "weapons/arc9_doi/p38/handling/p38_"
...
SWEP.Animations = {
    ...
    ["reload"] = { Source = "base_reload", MinProgress = 0.75, MagSwapTime = 1.25, Mult = 0.9,  EventTable = {
        {t = 0 / 30, s = path .. "magrelease.wav"},
        {t = 7 / 30, s = path .. "magout.wav"},
        {t = 35 / 30, s = path .. "magin.wav"},
        {t = 58 / 30, s = path .. "maghit.wav"},
    } },
    ["reload_empty"] = { Source = "base_reloadempty", MinProgress = 0.75, MagSwapTime = 1.25, Mult = 0.9, EventTable = {
        ...
        {t = 35 / 30, s = path .. "magin.wav"},
        {t = 58 / 30, s = path .. "maghit.wav"},
        {t = 71 / 30, s = path .. "boltrelease.wav"},
    } },
...
SWEP.CustomCamoTexture = "models/weapons/arc9_doi/waltherp38/weapon_p38_dm"
...
SWEP.Attachments = {
    ...
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p38_a.mdl"
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p38_b.mdl"
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p38_c.mdl"
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p38_d.mdl"
    },*/
}