...
SWEP.Description = [[Iconic German pistol predating the First World War.

"Si vis pacem, para bellum."]]

SWEP.ViewModel = "models/weapons/arc9_doi/c_lugerp08.mdl"
...
SWEP.PhysBulletMuzzleVelocity = 1150 * 12 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.SprintToFireTime = 0.28 -- How long it takes to go from sprinting to being able to fire.
...
SWEP.ShootSound = "weapons/arc9_doi/p08/p08_fp.wav"
SWEP.DistantShootSound = "weapons/arc9_doi/p08/p08_dist.wav"

SWEP.DryFireSound = "weapons/arc9_doi/p08/handling/p08_empty.wav"
...
SWEP.IronSights = {
    Pos = Vector(-1.695, -5, 1) * 1.3,
    Ang = Angle(0.05, 0.5, 6),
    Magnification = 1,
    ViewModelFOV = 60
}
...
local path = "weapons/arc9_doi/p08/handling/p08_"
...
SWEP.Animations = {
    ...
    ["reload"] = { Source = "base_reload", MinProgress = 0.75, MagSwapTime = 1.25, Mult = 0.9,  EventTable = {
        ...
        {t = 20 / 30, s = path .. "magout.wav"},
        {t = 57 / 30, s = path .. "magin.wav"},
        {t = 63 / 30, s = path .. "maghit.wav"},
    } },
    ...
    ["ready"] = { Source = "base_ready", MinProgress = 1, FireASAP = true, EventTable = {
        ...
        {t = 23 / 30, s = path .. "boltback.wav"},
        {t = 29 / 30, s = path .. "boltrelease.wav"},
    } },
    ...
    ["draw_empty"] = { Source = "empty_draw", EventTable = {
        {t = 0, s = ARC9DOI.PistolDraw},
    } },
    ["holster_empty"] = { Source = "empty_holster", EventTable = {
        {t = 0, s = ARC9DOI.PistolHolster},
    } },
...
SWEP.Attachments = {
    ...
    {
        PrintName = "GRIP",
        Category = {"doi_perk_holster", "doi_perk_burst"},
        Bone = "P08",
        Pos = Vector(0, -3, 0.5),
        Ang = Angle(0, -90, 0)
    },
    ...
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p08_a.mdl"
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p08_b.mdl"
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p08_c.mdl"
    },
    {
        PrintName = "STICKER",
        Category = "stickers",
        StickerModel = "models/weapons/arc9_doi/stickers/p08_d.mdl"
    },*/
}