...
SWEP.PrintName = "Spliterringgranate"
...
SWEP.Description = [[Stick grenade fitted with shrapnel fragmentation sleeve, making it more effective but heavier.]]

SWEP.ViewModel = "models/weapons/arc9_doi/c_splintering_stielhandgranate.mdl"
...
SWEP.ShootEnt = "doi_nade_spliterringgranate" -- Set to an entity to launch it out of this weapon.
