...
SWEP.Description = [[Smoke variant of the Stielhandgranate.]]

SWEP.ViewModel = "models/weapons/arc9_doi/c_nebelhandgranate.mdl"
...
SWEP.ShootEnt = "doi_nade_nebelhandgranate" -- Set to an entity to launch it out of this weapon.
...
SWEP.Animations = {
    ...
    ["throw"] = {
        ...
        MinProgress = 0.5,
        EventTable = {
            {s = path .. "ropepull.wav", t = 14 / 35},
            {s = path .. "armthrow.wav", t = 30 / 35},
        }
    },
    ["toss"] = {
        Source = "lowthrow",
        MinProgress = 0.5,
        EventTable = {
            {s = path .. "ropepull.wav", t = 10 / 33},
            {s = path .. "armthrow.wav", t = 23 / 33},
        }
    },
}