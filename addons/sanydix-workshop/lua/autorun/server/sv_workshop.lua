...
function DOWNLOADER:AddWorkshopResources()
    ...
    print("[Загрузчик аддонов] Начало загрузки " .. #addons .. " аддонов...")
    ...
    for _, addon in pairs(addons) do
        if addon.downloaded and addon.mounted then
            ...
            if shouldAdd then
                ...
                print("[Загрузчик аддонов] Добавление ресурсов:  " .. addon.title)
            end
        end
    end

    print("[Загрузчик аддонов] Окончание добавления ресурсов.")
end
