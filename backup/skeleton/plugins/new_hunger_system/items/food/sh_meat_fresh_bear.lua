ITEM.name = "Сырая медвежатина"
ITEM.description = "Богатый источник белка и железа"
ITEM.longdesc = "Сырое мясо медведя - богатый источник белка и железа с мясным вкусом и сочной текстурой, но требует правильной обработки перед употреблением, чтобы избежать рисков заболевания инфекциями."
...
ITEM.functions.use = {
    ...
    OnRun = function(item)
        ...
        ix.util.PlayerPerformBlackScreenAction(item.player, "Употребление...", 4, function(player) 
			ix.chat.Send(player, "me", "на грани рвоты, давясь от запаха, прожёвывает каждый кусочек сырого мяса медведя.")
		end)
