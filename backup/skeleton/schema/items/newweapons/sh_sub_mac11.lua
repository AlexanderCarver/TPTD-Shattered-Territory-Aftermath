ITEM.name = "MAC-11"
ITEM.description= "Американский пистолет-пулемёт MAC-11 калибра 9x17 мм."
ITEM.longdesc = "MAC-11 - компактный пистолет-пулемёт, созданный в 1970-х годах в США. Оружие работало на основе открытого затвора, имело магазин на 32 патрона калибра .380 или 9х19 мм и могло стрелять одиночными и автоматическими залпами. Из-за своих небольших размеров и высокой скорострельности оно было часто использовано в качестве средства самообороны."
ITEM.model = "models/weapons/w_smg_mac10.mdl"
ITEM.class = "arc9_fas_mac11"
