...
ITEM.description = "Высокотехнологичное помповое ружье Benelli M3, используемое в спортивной и охотничьей стрельбе."
ITEM.longdesc = "Помповое ружье 12 калибра, разработанное итальянской компанией Benelli, используется для спортивной и охотничьей стрельбы."
ITEM.model = "models/weapons/w_shot_m3super90.mdl"
ITEM.class = "arc9_fas_m3super90"
