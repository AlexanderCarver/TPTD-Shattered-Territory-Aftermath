ITEM.name = "P226"
ITEM.description= "Пистолет P226 калибра .357 SIG, выпускающийся швейцарско-немецкой компанией SIG Sauer."
ITEM.longdesc = "SIG P226 - это пистолет с двойным действием, который разработан для использования силами правопорядка и спецназом. Он имеет металлическую рамку и пластиковую рукоятку, на которой находятся вырезы для лучшего захвата. SIG P226 обладает хорошей точностью и управляемостью, а также имеет возможность использования высококалиберных патронов."
ITEM.model = "models/weapons/w_pist_p228.mdl"
ITEM.class = "arc9_fas_p226"
