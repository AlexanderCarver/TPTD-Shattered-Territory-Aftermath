...
ITEM.description= "Мощный полуавтоматический пистолет Desert Eagle калибра .50 AE."
ITEM.longdesc = "Desert Eagle - это мощный полуавтоматический пистолет с большим калибром. Он был разработан в Израиле и широко используется в кино и играх. Desert Eagle имеет большую ствольную коробку, крупную рукоятку и прямую нарезку на стволе. Этот пистолет может быть использован для охоты на крупную дичь или для самообороны в условиях экстремальной опасности."
ITEM.model = "models/weapons/w_pist_deagle.mdl"
ITEM.class = "arc9_fas_deagle"
...
ITEM.unloadedweight = 1.9  --Вес оружия
