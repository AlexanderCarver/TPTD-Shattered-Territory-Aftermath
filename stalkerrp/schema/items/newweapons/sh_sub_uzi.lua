ITEM.name = "Uzi"
ITEM.description= "Израильский пистолет-пулеме Uzi калибра 9x19 мм."
ITEM.longdesc = "Uzi - это израильский пистолет-пулемет, разработанный в 1940-х годах. Оружие было создано в ответ на необходимость компактного, складного и легкого пистолета-пулемета для использования в израильской армии. Uzi работал на основе принципа открытого затвора и использовал пистолетные патроны 9x19 мм. Он имел возможность стрелять как автоматически, так и одиночными выстрелами, и был очень популярен благодаря своей компактности, надежности и удобству в обращении."
ITEM.model = "models/weapons/w_smg_mac10.mdl"
ITEM.class = "arc9_fas_uzi"
