ITEM.name = "Травяной сбор из шмурдяка"
ITEM.description = "Металлическая кружка с напитком."
ITEM.longdesc = "Не совсем приятный, но крайне успокаивающий горький отвар из шмурдяка - одного из самого распространенного гриба на Территории. Лучше пить прохладным."
ITEM.model = "models/lostsignalproject/items/medical/drink_crow.mdl"
--достаёт кружку отвара из шмурдяка и быстро выпивает её, заметно зажмурившись.
