...
ITEM.longdesc = "Самая дешёвая пачка сигарет, которая часто встречается на Территории. Ужасный привкус горелой смолы перебивает вкус табака..."
ITEM.model = "models/lostsignalproject/items/consumable/cigarettes_russian.mdl"
--достаёт пачку сигарет Пётр I и берёт одну из них в рот, после чего закуривает, наполняя воздух горьким табачным дымом.
