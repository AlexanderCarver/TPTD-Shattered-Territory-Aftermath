...
ITEM.longdesc = "Сложно устроенный технически прибор с множеством датчиков, который улавливает показания внешней среды и издаёт звукой сигнал, если данные расходятся с нормами баз данных. Вы можете заметить маркировку 'A' на его обратной стороне..."
