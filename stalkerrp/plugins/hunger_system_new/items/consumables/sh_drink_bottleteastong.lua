...
ITEM:Hook("use", function(item)
	...
	ix.chat.Send(item.player, "iteminternal", "достает бежевую бутылку и делает несколько глотков желеобразной жидкости, после чего убирает ее обратно к себе в рюкзак.", false)
end)
