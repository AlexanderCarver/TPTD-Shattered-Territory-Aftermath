ITEM.name = "Апельсиновый сок 'Garden', 1 л"
...
ITEM:Hook("use", function(item)
	...
	ix.chat.Send(item.player, "iteminternal", "достает упаковку апельсинового сока 'Garden' и делает несколько глотков, после чего убирает ее обратно к себе в рюкзак.", false)
end)
