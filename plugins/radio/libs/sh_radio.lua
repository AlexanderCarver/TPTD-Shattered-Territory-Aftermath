...
function ix.radio.RadioSay(client, text, radioType)
	...
	chat.AddText(channel and channel.color or Color(42, 179, 0, 255), client:Name() .. " " .. rtext .. ", используя канал " .. name .. " \"" .. text .. "\"")
end
...
function ix.radio.EavesdropSay(client, text, radioType)
	...
	chat.AddText(ix.chat.classes.ic:GetColor(client, text), client:Name(), " ", rtext, " при Вас ", genderText, " \"", text, "\"")
end