...
function PLUGIN:GetReceivers()
	...
	for _, client in pairs(player.GetAll()) do
		if (IsCanUse[client:GetFaction()]) then
...
local IsCanUse = {
	...
	[FACTION_REGULAR] = true,
	[FACTION_COMMANDR] = true,
	[FACTION_FIELD] = true,
	[FACTION_MAIN] = true,
	[FACTION_OSVEG] = true,
	[FACTION_BIBLE] = true,
	[FACTION_SNOS] = true,
	[FACTION_ADIUNT] = true,
	[FACTION_PRECEPT] = true,
	[FACTION_HOSPITAL] = true,
	[FACTION_GREZ] = true,
	[FACTION_INQUSITION] = true
}
...
ix.command.Add("PTCreate", {
	...
	OnRun = function(self, client, index)
		if (not IsCanUse[client:GetFaction()]) then
