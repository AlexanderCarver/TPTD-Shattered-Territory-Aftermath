...
function PANEL:Init()
	...
	self.close.DoClick = function()
		if (self.bEditable) then
			netstream.Start("ixWritingEdit", self.itemID, self.text:GetValue():utf8sub(1, PLUGIN.maxLength))
		end
...
function PANEL:Think()
	...
	if (text:utf8len() > PLUGIN.maxLength) then
		local newText = text:utf8sub(1, PLUGIN.maxLength)

		self.text:SetValue(newText)
		self.text:SetCaretPos(newText:utf8len())
