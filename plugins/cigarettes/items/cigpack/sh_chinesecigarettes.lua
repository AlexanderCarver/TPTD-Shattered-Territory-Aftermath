ITEM.name = "Pack of Chinese Cigarettes"
ITEM.model = Model("models/kek1ch/drink_cigar3.mdl")
ITEM.description = "A small pack of pre-war Chinese cigarettes, unopened."
