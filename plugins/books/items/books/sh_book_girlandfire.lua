...
ITEM.name = "Девочка со спичками";
ITEM.price = 6
ITEM.model = Model("models/props_lab/bindergreenlabel.mdl")
ITEM.description = "Книга в которой написан рассказ Ганса Христиана Андерсена";
ITEM.contents = [[
<font color='red' size='4'>Written by Ганса Христиан Андерсен.</font>
<br><br>
