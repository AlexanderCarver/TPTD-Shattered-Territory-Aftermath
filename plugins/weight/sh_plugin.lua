...
ix.config.Add("maxWeight", 30, "Максимальный вес в килограммах, который может удержать персонаж.", nil, {
	data = {min = 1, max = 100},
	category = "Weight"
})

ix.config.Add("maxOverWeight", 20, "Максимальный вес в килограммах, который может перейти порог перегрузки.", nil, {
	data = {min = 1, max = 100},
	category = "Weight"
})
