...
ix.container.Register("models/mark2580/gtav/mp_office_03c/warehouse_crates/closed_bc.mdl", {
	name = "Ящик с оружием",
	description = "Хорошо укрепленной армированной рамой ящик, в котором есть что-то.",
	width = 8,
	height = 12,
})

ix.container.Register("models/sal/office/officeshelf.mdl", {
	name = "Офисный шкаф",
	description = "Офисная полка с документами, которая стоит практически в каждом кабинете.",
	width = 3,
	height = 10,
})
