...
LANGUAGE = {
	...
	playerConnected = "%s был подключен к Corporate Security Network.",
	playerDisconnected = "%s был отключен от Corporate Security Network.",
	...
	youreDead = "Вас вывели из строя.",
	injMajor = "Этот человек выглядит сильно раненным. Требуется срочная медицинская помощь.",
	injLittle = "Этот человек ранен. Требуется медицинская помощь.",
	chgName = "Сменить имя",
	...
	salary = "Вы получили свою часовую дотацию в размере: %s. Вы вольны потратить её туда, куда посчитаете нужным.",
	...
	tying = "Связывание...",
	unTying = "Освобождение...",
	isTied = "Связан(а)",
	fTiedUp = "Вы были связаны.",
	fBeingTied = "Вас связывают...",
	tiedUp = "Они были связаны.",
	beingTied = "Их связывают...",
	beingUntied = "Их освобождают...",
	needRequestDevice = "Вам нужно устройство-передатчик для того, чтобы сделать это.",
	vendingNeedMoney = "Вам нужно %s UCE, чтобы произвести покупку.",
	vendingPurchased = "Вы купили продукты за %s UCE.",
	vendingRestocked = "Вы восстановили запасы автомата.",
	cantViewData = "Вы не можете посмотреть данные файлы.",
	lastEdit = "В последний раз отредактировано",
	lastEditDate = "Дата",
	objectivesTitle = "Текущие задачи",
	searchingCorpse = "Обыскиваем труп...",
	economy = "Экономика",

	-- combine display messages
	cViewData = "<ЗАГРУЗКА ТЕКУЩЕГО ПЕРСОНАЛЬНОГО КОРПОРАТИВНОГО ДОСЬЕ...>",
	cViewDataExpired = "<ОШИБКА! ЗАГРУЗКА ТЕКУЩЕГО ПЕРСОНАЛЬНОГО КОРПОРАТИВНОГО ДОСЬЕ НЕВОЗМОЖНА.>",
	cViewDataUpdate = "<ОБНОВЛЕНИЕ ТЕКУЩЕГО ПЕРСОНАЛЬНОГО КОРПОРАТИВНОГО ДОСЬЕ...>",
	cViewDataFiller = "<ОБНОВЛЕНИЕ ТЕКУЩЕГО СПИСКА ПЕРСОНАЛЬНОГО КОРПОРАТИВНОГО ДОСЬЕ...>",
	cViewObjectives = "<ЗАГРУЗКА ТЕКУЩЕГО СПИСКА ПРИОРИТЕТНЫХ ЗАДАЧ...>",
	cViewObjectivesUpdate = "<ОБНОВЛЕНИЕ ТЕКУЩЕГО СПИСКА ПРИОРИТЕТНЫХ ЗАДАЧ...>",
	cViewObjectivesFiller = "<ЗАГРУЗКА ТЕКУЩЕГО СПИСКА ПРИОРИТЕТНЫХ ЗАДАЧ... РЕДАКЦИЯ: %d.>",
	cCivilJudgement = "<ПОДГОТОВКА ТЕКУЩЕГО ПРОТОКОЛА НАРУШЕНИЙ КОРПОРАТИВНЫХ РЕГУЛЯЦИЙ Directorate of the Tower Coporation...>",
	cRequest = "<ВНИМАНИЕ! ЗАГРУЗКА ЗАПРОСА...>",
	cCitizenLoaded = "<РЕГИСТРАЦИЯ СПИСКА НОВЫХ СОТРУДНИКОВ... ОБНОВЛЕНИЕ ПРОТОКОЛОВ.>",
	cCombineLoaded = "<РЕГИСТРАЦИЯ СПИСКА НОВЫХ СОТРУДНИКОВ СЛУЖБ БЕЗОПАСНОСТИ... ОБНОВЛЕНИЕ ПРОТОКОЛОВ.>",
	cLostBiosignal = "<ВНИМАНИЕ! ОБНАРУЖЕН ОБРЫВ СИГНАЛА С СОТРУДНИКОМ!>",
	cLostBiosignalLocation = "<ПОСЛЕДНЯЯ ДИСЛОКАЦИЯ СИГНАЛА: %s.>",
	cTrauma = "<ВНИМАНИЕ! ОБНАРУЖЕНО ПОЛУЧЕНИЕ %s ПОВРЕЖДЕНИЙ!>",
	cDroppingVitals = "<ВНИМАНИЕ! ТЕКУЩЕЕ СОСТОЯНИЕ ЗДОРОВЬЯ В КРИТИЧЕСКОМ СОСТОЯНИИ. ТРЕБУЕТСЯ СРОЧНАЯ МЕДИЦИНСКАЯ ПОМОЩЬ.>",
	cStaminaLost = "<ВНИМАНИЕ! ОБНАРУЖЕНО ЭНЕРЕГИТИЧЕСКОЕ УТОМЛЕНИЕ ОРГАНИЗМА... ВЫПОЛНЕНИЕ ПРОТОКОЛОВ ВОССТАНОВЛЕНИЯ.>",
	cStaminaGained = "<ПРОТОКОЛЫ ВОССТАНОВЛЕНИЯ ЗАВЕРШЕНЫ: ИНЪЕКЦИЯ ПРОШЛА УСПЕШНО.>",
