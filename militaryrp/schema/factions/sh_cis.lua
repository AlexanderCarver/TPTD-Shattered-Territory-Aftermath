FACTION.name = "The Conqueror-8157 SQUADCOM CIS: 116th Delta Team"
FACTION.description = ""
FACTION.color = Color(0, 128, 128, 255)
...
FACTION.Ranks = {
    [1] = {"RANK: [HQS] | Staff Sergeant", nil, CLASS_CISREGULAR},
    [2] = {"RANK: [HQSS] | Senior Sergeant", nil, CLASS_CISREGULAR},
    [3] = {"RANK: [HQPS] | Platoon Sergeant", nil, CLASS_CISREGULAR},
	----------------------------------------------------------------------
    [4] = {"RANK: [L1] | Ensign", nil, CLASS_CISREGULAR},
    [5] = {"RANK: [L2] | Lieutenant", "icon16/asterisk_orange.png", CLASS_CISDEPCOM, true},
    [6] = {"RANK: [ML] | Master Lieutenant", "icon16/asterisk_yellow.png", CLASS_CISCOM, true}
}
...
FACTION_CORPORATEINTELLIGENCESERVICE = FACTION.index