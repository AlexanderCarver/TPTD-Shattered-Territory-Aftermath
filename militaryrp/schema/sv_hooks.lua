...
function Schema:TakeDamage(client, inflicter, attacker)
		local location = client:GetArea() or "unknown location"

		self:AddCombineDisplayMessage("Тестирование дамага.")
		...
		local sounds = {"buttons/combine_button3.wav", "buttons/combine_button7.wav"}
		local chance = math.random(1, 7)

		if (chance == 2) then
			sounds[#sounds + 1] = "buttons/combine_button5.wav"
