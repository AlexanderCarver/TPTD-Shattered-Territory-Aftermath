...
ITEM.longdesc = "Один из наиболее старых брендов из Великобритании, где по прежнему имеет сильное влияние. Средней крепости табак для самокруток."
ITEM.model = "models/lostsignalproject/items/consumable/hand_rolling_tobacco.mdl"
--достаёт пачку табака “Golden Virginia” и кусочек бумаги, после чего делает самокрутку и закуривает, наполняя воздух густым сигаретным дымом.
