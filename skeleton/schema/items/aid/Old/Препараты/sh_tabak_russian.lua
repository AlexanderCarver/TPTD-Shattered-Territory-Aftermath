...
ITEM.longdesc = "Аккуратно упакованная тёмно-оранжевая пачка табака с запахом ягод и дуба. Пахнет достаточно приятно… На первый взгляд, в пачке табака на 500 г."
ITEM.model = "models/lostsignalproject/items/misc/tobacco.mdl"
--достаёт пачку табака “Русский” и кусочек бумаги, после чего делает самокрутку и закуривает, наполняя воздух густым сигаретным дымом.
