...
ITEM.longdesc = "Табачная сигарета 4-го класса. Имеет сладкий травянистый запах. При курении остаётся сладкое послевкусие и сухость во рту."
ITEM.model = "models/lostsignalproject/items/consumable/cigarettes_sparkle.mdl"
--достаёт пачку сигарет Искра и берёт одну из них в рот, после чего закуривает, наполняя воздух горьким табачным дымом.
